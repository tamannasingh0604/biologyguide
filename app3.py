...
/* YouTube Button */
a.yt-link {
    display: inline-block; background: linear-gradient(90deg, #be123c, #e11d48);
    color: white !important; padding: 12px 24px; border-radius: 8px;
    text-decoration: none; font-weight: 700; margin: 15px 0; transition: transform 0.2s;
}
a.yt-link:hover { transform: translateY(-2px); }
</style>
...
tabs = st.tabs(["1. Intro", "2. Flower Anatomy", "3. Stamen & Pollen", "4. Pistil & Ovule", "5. Pollination", "6. Fertilisation", "7. Seed Dev", "8. Apomixis", "9. Last Min Notes", "10. Trivia Time"])
