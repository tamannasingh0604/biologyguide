...
/* Image Boxes */
.diagram-box { background: #ffffff; border: 3px dashed #10b981; padding: 20px; border-radius: 15px; text-align: center; margin-bottom: 25px; }
...
with tabs[0]:
    ...
    st.markdown("<h3 style='color:#059669;'>🖼️ Life Cycle Overview</h3>", unsafe_allow_html=True)
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Angiosperm_life_cycle_diagram.svg/800px-Angiosperm_life_cycle_diagram.svg.png", caption="Angiosperm Life Cycle")
...
with tabs[1]:
    ...
    st.markdown("<div class='diagram-box'>", unsafe_allow_html=True)
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/Mature_flower_diagram.svg/800px-Mature_flower_diagram.svg.png", caption="Flower Anatomy")
    st.markdown("</div>", unsafe_allow_html=True)
...
with tabs[2]:
    ...
    st.markdown("<div class='diagram-box'>", unsafe_allow_html=True)
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Anther_wall.svg/800px-Anther_wall.svg.png", caption="T.S. of Anther")
    st.markdown("</div>", unsafe_allow_html=True)
...
with tabs[3]:
    ...
    st.markdown("<div class='diagram-box'>", unsafe_allow_html=True)
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Angiosperm_ovule.svg/500px-Angiosperm_ovule.svg.png", caption="Anatropous Ovule")
    st.markdown("</div>", unsafe_allow_html=True)
...
with tabs[4]:
    ...
    st.markdown("<div class='diagram-box'>", unsafe_allow_html=True)
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Pollination.svg/600px-Pollination.svg.png", caption="Pollination Agents")
    st.markdown("</div>", unsafe_allow_html=True)
...
with tabs[5]:
    ...
    st.markdown("<div class='diagram-box'>", unsafe_allow_html=True)
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Double_Fertilization.svg/600px-Double_Fertilization.svg.png", caption="Double Fertilisation")
    st.markdown("</div>", unsafe_allow_html=True)
...
with tabs[6]:
    ...
    with col1:
        st.markdown("<div class='diagram-box'>", unsafe_allow_html=True)
        st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Dicot_embryo.svg/500px-Dicot_embryo.svg.png", caption="Dicot Embryo")
        st.markdown("</div>", unsafe_allow_html=True)
    with col2:
        st.markdown("<div class='diagram-box'>", unsafe_allow_html=True)
        st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Monocot_embryo.svg/500px-Monocot_embryo.svg.png", caption="Monocot Embryo")
        st.markdown("</div>", unsafe_allow_html=True)

# --- 8: APOMIXIS ---
with tabs[7]:
    st.markdown("<h2 class='gradient-text-2'>8. Apomixis</h2>", unsafe_allow_html=True)
    st.markdown("""
    <div class="bio-card">
    <b>Apomixis:</b> Asexual reproduction that mimics sexual reproduction by producing seeds without fertilisation. Progeny are exact clones.
    </div>
    """, unsafe_allow_html=True)
